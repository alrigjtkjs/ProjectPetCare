...
<%@include file="../header.jsp" %>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span>Pet Care Form form Helper<i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-0 bread">돌보미 지원하기</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
		<div class="container">
			...
			<form class="helpf" name="helpf" action="he_write.do" method="post">            
            <div class="table table-responsive">
               ...
               <table class="table table-striped table table-bordered">
		            ...
		            <tr>
		               <td class="td-color">내용</td>
		               <td><textarea rows="5" cols="50" name="content" class="form-control" placeholder="제공 가능한 돌봄 내용을 작성해주세요"></textarea></td>
		            </tr>
            	</table>
		            <br>
		            <h4>돌봄 이웃 선택</h4>
               <table class="table table-striped table table-bordered">
	            ...
	            <div class="write-btn" align="center">
	               ...
	               <button type="submit" class="btn btn-info btn-lg" id="saveButton">등록</button>
	            </div>
         	</div>
         	</form>			
		</div>
