				...
				<div class="col-sm-6 col-md-4" id="imgThumnail">
					<div class="card text-white">
						...
						<div class="card-img-overlay">
							...
							data-gseq="${gallery.g_seq}" data-email="${gallery.email}" data-cont="${gallery.content}" data-likes="${gallery.likes}" 
							data-views="${gallery.views}" data-wdate="${gallery.wdate}" data-imgs="${imgNames[status.index]}">
								<span class="card-text">
								<i class="fa fa-heart" aria-hidden="true"></i>${gallery.likes}
								<i class="fa fa-eye" aria-hidden="true"></i>${gallery.views}
								<i class="fa fa-clock-o" aria-hidden="true"></i>${gallery.wdate}
								<h5 class="card-title text-white" id="contentTitle"><strong>${gallery.content}</strong></h5>
							</span> 
							</a>
						</div>
					</div>	
						...
						<div class="modal-footer">
							<c:choose>
								...
								<c:otherwise>
									...
									<button type="submit" class="btn btn-primary btn-sm" data-dismiss="modal" id="comment-btn" onClick="alert('로그인 회원만 이용가능합니다.')">입력</button>
								</c:otherwise>
							</c:choose>
						</div>
					</div>
