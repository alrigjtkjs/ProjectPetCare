	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 ftco-animate">
				...
				<h2 class="mb-3">${carereview.writer}님의 후기</h2>
				<h2 class="mb-3">돌보미: ${carereview.dolbomy}</h2>
				<p>${carereview.content}</p>
				<h2 class="mb-3 mt-5"></h2>
				<div style="text-align: center;">
					<button onclick="location.href='del.do?cr_seq=${carereview.cr_seq}'">삭제 </button> 
					<button onclick="location.href='update?cr_seq=${carereview.cr_seq}'">수정</button>
				</div>
			</div>
